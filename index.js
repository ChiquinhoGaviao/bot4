		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[鉂梋 ESTE PEDIDO 脡 ESPEC脥FICO PARA USUARIO MOD NABUTO BOT*',
					...
					userB: `鈹�鈹�銆� LISTA 銆嶁攢鈹�\nOl谩 Kak !\nDesculpe, irm茫. Voc锚 n茫o est谩 registrado como amigo de nabuto. Registre-se para fazer amizade com o bot Nabuto por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar nabuto|14\n\n鈹�鈹�銆� Nabuto BOT 銆嶁攢鈹�`,
			...
			const ownerNumber = ["55418453751@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"55418453751@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["55418453751@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["55418453751@s.whatsapp.net"]//ubah nomor lo
			const premium = ["55418453751@s.whatsapp.net",]#
...
// recursos anime, random @nabuto domina vida
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*鈺攢鈹�鈹�鈹�*銆� *ADMINBOT NABUTO 鉁�* 銆峔n*鈹�+ wa.me/556993733829*鈺扳攢鈹�鈹�鈹�鈹�鈹�*銆� *NABUTO* 銆�*鈹�鈹�鈹�鈹�*\n\n*_SE QUER SER ADMIN DO BOT NABUTO_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*鈺攢鈹�鈹�鈹�*銆� *PREMIUM USER馃憫* 銆峔n*鈹�+ wa.me/556993733829*鈺扳攢鈹�鈹�鈹�鈹�鈹�*銆� * NABUTO* 銆�*鈹�鈹�鈹�鈹�*\n\n*_SE QUER SER UM USU脕RIO PREMIUM DO NABUTO BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
